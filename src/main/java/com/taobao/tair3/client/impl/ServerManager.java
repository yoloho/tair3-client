...
public class ServerManager {
    ...
    public TairResultFutureImpl<GetGroupResponse, Result<Void>> asyncGrabGroupConfig()
        ...
        if (nextConfigServerIndex >= csList.size()) {
            ...
            try {
                ...
                future = context.callAsyncUnlimit(csList.get(nextConfigServerIndex), request, UPDATER_TIMEOUT,
                        GetGroupResponse.class, PacketFactory.getInstance(), null);
